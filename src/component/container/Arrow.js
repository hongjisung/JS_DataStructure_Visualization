...
const Arrow = (startx, starty, endx, endy, className="Arrow", key=0, ani_delay='0s', ani_dur='0s') => {
  ...
  return (
    [
      <line key={key} className={className} x1={startx} y1={starty} x2={endx} y2={endy} style={{stroke: "black", strokeWidth:1, animationDelay: ani_delay, animationDuration: ani_dur}}/>,
